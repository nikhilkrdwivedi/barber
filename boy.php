...
<div class="row">
    <div class="col-md-4">
        ...
        <section id="sec1">
        <div class="effect">
          <img src="images\b1.jpg"  alt="Avatar" class="image">
          <div class="middle">
           <div class="text"><a href="book.php">BOOK</a></div>
          </div>
     
          <figcaption>Alan beak best haircuts (5 Dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4">
        ...
        <div class="effect">
          ...
          <figcaption>chop a gram spiky boys hairstyles(10 Dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4" > 
        <section id="sec1">
        <div class="effect">
          ...
          <figcaption>dancemom tiffanieboys haircuts(8 Dollars)</figcaption>
         </section>
    </div>
</div>
<br>
<div class="row">
    <div class="col-md-4">
        ...
        <div class="effect">
          ...
          <figcaption>joshconnollybarber haircuts for curly hair boys(4 Dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4">
        ...
        <div class="effect">
          ...
          <figcaption>styledbysmythy pomp fade for boys medium length(6 Dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4" > 
        <section id="sec1">
        <div class="effect">
          <img src="images\b6.jpg" alt="Avatar" class="image">
          <div class="middle">
           <div class="text"><a href="book.php">BOOK</a></div>
          </div>
     
          <figcaption>trencitajohnson good haircuts for boys(5 Dollars)</figcaption>
         </section>
    </div>
</div>

    ...
    <div class="row">
      ...
      <div class="col-md-offset-2 col-md-8 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        <div class="section-title">
          <h1>Kid's Product & Services</h1>
          <p>Catch latest and treading grooming for your loving prince or princess. We are here to make them a perfect cute kid. So, what are you waiting for choose your product/servies. </p>
        </div>
      </div>
      ...
      <ul class="grid cs-style-4">
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/kidhair.jpg" width="500px" height="300px" alt="image 1"></div>
            <figcaption><br><br>
              <h1>Boys Hair Cuts</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/kidgirl.jpg" width="500px" height="300px" alt="image 2"></div>
            <figcaption>

            <br><br>
              <h1>Girls Hair Cuts</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/kidear.jpg" width="500px" height="300px" alt="image 3"></div>
            <figcaption><br>
              <h1>Ear Piercing</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/kidupdo.jpg" width="500px" height="300px" alt="image 4"></div>
            <figcaption>
            <br><br>
              <h1>Party Up Do</h1>

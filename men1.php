...
<div class="row">
    <div class="col-md-4">
        ...
        <div class="effect">
          ...
          <figcaption>Skin Fade and Blunt Cut Fringe (9 dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4">
        ...
        <div class="effect">
          ...
          <figcaption>Classic Pompadour Haircut (5 dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4" > 
        <section id="sec1">
        <div class="effect">
          ...
          <figcaption>Modern Pompadour and High Fade (7 dollars) </figcaption>
         </section>
    </div>
</div>
<br>
<div class="row">
    <div class="col-md-4">
        ...
        <section id="sec1">
        <div class="effect">
          <img src="images\6.jpg" alt="Avatar" class="image">
          <div class="middle">
           <div class="text"><a href="book.php">BOOK</a></div>
          </div>
     
          <figcaption>Short Sides and Medium Hair On Top (5 dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4">
        ...
        <section id="sec1">
        <div class="effect">
          <img src="images\5.jpg" alt="Avatar" class="image">
          <div class="middle">
           <div class="text"><a href="book.php">BOOK</a></div>
          </div>
     
          <figcaption>High Fade and Textured Quiff Haircut (8 dollars)</figcaption>
         </section>
    </div>
    <div class="col-md-4" > 
        <section id="sec1">
        <div class="effect">
          <img src="images\4.jpg" alt="Avatar" class="image">
          <div class="middle">
           <div class="text"><a href="book.php">BOOK</a></div>
          </div>
     
          <figcaption>Men’s Haircut For Wavy Hair (6 dollars)</figcaption>
         </section>
    </div>
</div>

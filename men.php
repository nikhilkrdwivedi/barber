    ...
    <div class="row">
      ...
      <div class="col-md-offset-2 col-md-8 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        <div class="section-title">
          <h1>Men's Product & Services</h1>
          <p>Catch latest and treading grooming for men. We are here to make you a perfect gentlemen. So, what are you waiting for choose your product/servies. </p>
        </div>
      </div>
      ...
      <ul class="grid cs-style-4">
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/haircut.jpg" width="500px" height="300px" alt="image 1"></div>
            <figcaption><br><br>
              <h1>Hair Cut</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/color.jpg" width="500px" height="300px" alt="image 2"></div>
            <figcaption>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/beard.jpg" width="500px" height="300px" alt="image 3"></div>
            <figcaption><br>
              <h1>Beard Saving</h1><h1> & </h1><h1>Treaming</h1>
        ...
        <li class="col-md-6 col-sm-6">
          <figure>
            <div><img src="images/othermen.jpg" width="500px" height="300px" alt="image 4"></div>
            <figcaption>
            <br><br>
